...
// Google Ads Call Conversion Tracker
const trackCall = () => {
  if (typeof window !== "undefined" && (window as any).gtag) {
    (window as any).gtag("event", "conversion", {
      send_to: "AW-17832329846",
    });
  }
};

const WA_LINK =
  "https://wa.me/917268838241?text=Hello%20Nandi%20Travels,%20I%20want%20to%20book%20a%20cab.%20Please%20share%20price%20and%20availability.";
    ...
    <div className="grid md:grid-cols-3 gap-8">
      {[
        ...
        >
          ...
          <div className="flex gap-3">
  <a href={WA_LINK} target="_blank" onClick={trackWhatsApp} className="inline-block bg-black text-white px-6 py-3 rounded-xl font-semibold">
    Book This Trip
  </a>
  {(service as any).link && (
    <a href={(service as any).link} className="inline-block bg-yellow-400 text-black px-6 py-3 rounded-xl font-semibold">
      View Details
    </a>
  )}
</div>
